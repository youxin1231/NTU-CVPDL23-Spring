...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--yaml', type=str, default='data/dataset_org.yaml', help='data yaml file.')
    parser.add_argument('--img-size', nargs='+', type=int, default=[2048, 2048], help='the image-size(h,w) in inference size.')
    parser.add_argument('--conf-thres', type=float, default=0.03, help='confidence threshold for inference.')
    parser.add_argument('--iou-thres', type=float, default=0.8, help='NMS IoU threshold for inference.')
