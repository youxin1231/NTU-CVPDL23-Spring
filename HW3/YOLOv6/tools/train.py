...
def get_args_parser(add_help=True):
    ...
    parser.add_argument('--data-path', default='./data/dataset_org.yaml', type=str, help='path of dataset')
    parser.add_argument('--conf-file', default='./configs/yolov6l6_finetune.py', type=str, help='experiments description file')
    parser.add_argument('--img-size', default=2048, type=int, help='train, val image size (pixels)')
    ...
    parser.add_argument('--heavy-eval-range', default=0, type=int,
